...
```sh
git clone git@github.com:SebastianBr11/kickstart.nvim.git .config/nvim-plus
```
...
```
sudo pacman -S --noconfirm --needed gcc make git ripgrep tree-sitter-cli fd unzip neovim
```
